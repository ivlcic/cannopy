...
from .__common import _load_samples, _group_by_article_id, _split_ids_random, _write_split_file, _write_labels_file
...
def main(data_args: DataArguments) -> None:
    ...
    for split_name in ['train', 'eval', 'test']:
        target_file = target_dir / f'{subset}_{split_name}.jsonl'
        split_counts[split_name] = _write_split_file(target_file, split_ids[split_name], grouped)

    labels_file = target_dir / f'{subset}_labels.jsonl'
